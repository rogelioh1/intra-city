...
Choose to stay with Tot in Chapter 1. Remember the password you get when you reach the map room in the library. Run for the computer when facing Chief. When prompted, enter the password. If correct, will unlock the leave ending for Tot route.
...
Choose to leave and join the highway guards in chapter 1. Don’t take the stairs when you enter the lookout building. Instead, take investigate the strange room. You'll learn the location of the detonator, unlocking the leave ending for Hunter route.
